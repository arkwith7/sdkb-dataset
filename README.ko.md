...
| **유망기술 기회 발굴** | Novelty-focused patent mapping, emerging-memory 토픽 클러스터 | [활용 사례 1](#활용-사례), 🚧 notebook 02 |
| **중소기업 혁신 성과 분석 / 전문가 매칭** | SDKB-Match Expert + 합성 100 + 큐레이션 110 전문가 풀 + 다중관할 컴플라이언스 게이트 | [활용 사례 2](#활용-사례), 🚧 notebook 01, ✅ notebook 05 |
<!-- 공개본에서 뺀다: 시각화·Pages 는 공개본에 없다 -->

| 조직적 R&D 관리 / 혁신 디자인 (보조축) | RBV 핵심자원 조합 + TRL / 실물옵션 시드 노드 | [활용 사례 4](#활용-사례), 🚧 notebook 03 |
...
4-pillar 상세 매핑: docs/project/research_alignment.md.
...
- 누수(leakage) 프로토콜 — docs/leakage_protocol.md
...
- main에 푸시되면 .github/workflows/viz-deploy.yml이 자동으로 site/를 재빌드해 GitHub Pages로 배포
- 1회 설정: 레포 **Settings → Pages → Source: GitHub Actions** 선택
- 상세: docs/project/visualization_plan.md
...
- 7,500 examiner-grounded(객관 KIPO 인용) + 7,800 알고리즘 시뮬레이션 3-rater 합성 평점 — **인간 전문가 주석 아님** (dual-track GT). 3-rater 신뢰도: weighted κ = 0.550 / ICC(2,k) = 0.787 (합의); 투명성: Fleiss κ = 0.258 / ICC(2,1) = 0.552 — data/experts/reliability_report.md
