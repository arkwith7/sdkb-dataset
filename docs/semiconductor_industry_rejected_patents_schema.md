...
2026-05-16 기준 canonical file은 **1000건** 입니다. 이 시점에 `dataset_full_collection_runbook.md` Phase A/C 적용으로 다음 신규 필드가 추가되었습니다.
...
실제 merge는 scripts/merge_legacy_etch_into_semiconductor_dataset.py로 수행했습니다.
